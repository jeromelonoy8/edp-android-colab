...
fun ProfileScreen(postsVm: PostsViewModel, themeVm: ThemeViewModel) {
    ...
    Column(
        ...
        Text("Jerome Yu Lonoy", style = MaterialTheme.typography.headlineSmall)
        Text("@JeromeYu05", style = MaterialTheme.typography.bodyMedium)
        Text("BSIT3-2 · Liceo de Cagayan University",
